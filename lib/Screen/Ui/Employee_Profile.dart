                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 20,),
                              Align(alignment: Alignment.center , child: Text('status:-  ${widget.tech['available'] == true ? "available" : "Not available" } ',style: TextStyle(fontWeight: FontWeight.bold),).tr(),),

                              SizedBox(height: 20,),
                              Align(alignment: Alignment.center  , child: Text('WorkTime:- ${widget.tech['from']} to ${widget.tech['to']}').tr(),),
                              SizedBox(height: 20,),
                              Align(alignment: Alignment.center, child: Text('Service Price :- ${widget.tech['price']}').tr(),),
                              SizedBox(height: 20,),
